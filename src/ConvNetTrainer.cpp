...
*
*	Usage:
*		./ConvNetTrainer binaryTrainingImagesFile outname=<outputName.txt> epochs=<#epochs>
*
* 		The outputName and epochs are optional keyword arguments. If no outname is specified the weights are not saved. Epochs defaults to 1.
*
*************************************/
...
int main(int argc, char** argv)
{
	if(argc < 3)
	{
		cout << "Usage: ./ConvNetTrainer newCNNConfigFile.txt binaryTrainingImagesFile outname=<outputName.txt> epochs=<#epochs>\n\tThe outputName and epochs are optional keyword arguments. If no outname is specified the weights are not saved. Epochs defaults to 1." << endl;
		return 0;
	}
